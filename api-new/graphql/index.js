...
var drone_resolver_1 = require("./drone-resolver");
...
function bootstrap() {
    return __awaiter(this, void 0, void 0, function () {
        var schema, app, server, httpServer, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, TypeGraphQL.buildSchema({
                            resolvers: [drone_resolver_1.DroneResolver]
                        })];
                case 2:
                    schema = _a.sent();
